...
set C_modelArgList {
	{ agg_result_dist int 32 regular {pointer 2}  }
	{ agg_result_end_position int 32 regular {pointer 1}  }
	{ x int 32 regular {array 250 { 1 1 } 1 1 }  }
	{ y int 32 regular {array 48497 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "agg_result_dist", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "agg.result.dist","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ agg_result_dist_i sc_in sc_lv 32 signal 0 } 
	{ agg_result_dist_o sc_out sc_lv 32 signal 0 } 
	{ agg_result_dist_o_ap_vld sc_out sc_logic 1 outvld 0 } 
	...
	{ x_address1 sc_out sc_lv 8 signal 2 } 
	{ x_ce1 sc_out sc_logic 1 signal 2 } 
	{ x_q1 sc_in sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "agg_result_dist_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "agg_result_dist", "role": "i" }} , 
 	{ "name": "agg_result_dist_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "agg_result_dist", "role": "o" }} , 
 	{ "name": "agg_result_dist_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "agg_result_dist", "role": "o_ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "6063624", "EstimateLatencyMax" : "6063624",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			{"Name" : "agg_result_dist", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "agg_result_end_position", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "x", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "y", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_min3_fu_196359", "Parent" : "0",
		"CDFG" : "min3",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_min3_fu_196616", "Parent" : "0",
		"CDFG" : "min3",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set ArgLastReadFirstWriteLatency {
	subsequence_search {
		agg_result_dist {Type IO LastRead 503 FirstWrite 3}
		agg_result_end_position {Type O LastRead -1 FirstWrite 5}
		x {Type I LastRead 129 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "6063624", "Max" : "6063624"}
	, {"Name" : "Interval", "Min" : "6063625", "Max" : "6063625"}
]}
...
set Spec2ImplPortList { 
	agg_result_dist { ap_ovld {  { agg_result_dist_i in_data 0 32 }  { agg_result_dist_o out_data 1 32 }  { agg_result_dist_o_ap_vld out_vld 1 1 } } }
