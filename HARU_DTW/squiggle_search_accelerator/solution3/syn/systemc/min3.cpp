...
void min3::thread_ap_return() {
    ap_return = (!icmp_ln11_fu_40_p2.read()[0].is_01())? sc_lv<16>(): ((icmp_ln11_fu_40_p2.read()[0].to_bool())? c.read(): select_ln7_fu_32_p3.read());
}

void min3::thread_icmp_ln11_fu_40_p2() {
    icmp_ln11_fu_40_p2 = (!select_ln7_fu_32_p3.read().is_01() || !c.read().is_01())? sc_lv<1>(): (sc_bigint<16>(select_ln7_fu_32_p3.read()) > sc_bigint<16>(c.read()));
}

void min3::thread_icmp_ln7_fu_26_p2() {
    icmp_ln7_fu_26_p2 = (!b.read().is_01() || !a.read().is_01())? sc_lv<1>(): (sc_bigint<16>(b.read()) < sc_bigint<16>(a.read()));
}

void min3::thread_select_ln7_fu_32_p3() {
    select_ln7_fu_32_p3 = (!icmp_ln7_fu_26_p2.read()[0].is_01())? sc_lv<16>(): ((icmp_ln7_fu_26_p2.read()[0].to_bool())? b.read(): a.read());
}
